...
# ==============================================================================
"""Implementation of the Simmer version of the TRPOLag algorithm."""
"""Adapted by Carleton College's Safe RL group."""
...
@registry.register
class TRPOLagSimmerPID(TRPOLag):
    """The Simmer version(based on PID controller) of the TRPOLag algorithm.
